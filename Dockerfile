...
ADD services/data/service_configs.py /metaflow/services/
...
ADD setup.py setup.cfg run_goose.py /metaflow/
WORKDIR /metaflow
...
RUN pip3 install -r /metaflow/services/migration_service/requirements.txt

RUN chmod 777 /metaflow/services/migration_service/run_script.py
